...
class Trainer():
    def __init__(self, task: str, language_map:{}, language_codes:[], train_files: {}, dev_files: {}, test_files: {}, args):
        self.task = None
        ...
        if i > 0:
            if i>=len(self.store_prefix)-1:
                raise Exception("store_prefix is a folder; please specify the prefix of the models after the '/', like 'data/tagger'.")
