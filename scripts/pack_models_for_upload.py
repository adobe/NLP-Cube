...
if __name__ == "__main__":
    refresh = False
    folder_with_base_confs = os.path.abspath("examples//multilanguage//autogenerated//")
    folder_with_all_trained_models = os.path.abspath("data")
    folder_where_to_output_everything = os.path.abspath("nlp-cube-models")
    url_root_for_models = "https://github.com/adobe/NLP-Cube-Models/blob/2.0/models/" # !! make sure it ends with an /
    ...
    for fam in d:
        ...
        #print(model_files)
        model_files = [x for x in model_files if fam in x and ".last" not in x and ".zip" not in x]
        #print(model_files)
